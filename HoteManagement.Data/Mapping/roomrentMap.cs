...
namespace HoteManagement.Data.Mapping
{
    ...
    public class roomrentMap : BaseEntityTypeConfiguration<HoteManagement.Domain.roomrent>
    {
       public roomrentMap()
       {
          this.HasKey(t => t.Id);
          this.Property(t => t.goodname).HasMaxLength(50);
          this.Property(t => t.goodnum);
